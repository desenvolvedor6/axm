...
class RestController extends \Phalcon\Mvc\Controller {
     ...
     * 
     * Ex : url: /usuario/search/name/hugo/email/hugo.martin3093@gmail.com/order/name
     *      sql generated: select * from user where name='hugo' and email='hugo.martin3093@gmail.com' order by name
     * Ex2 : url: /user/search/id_produto/(IN)1,2/order/name
     *      sql generated: select * from user where id_produto in (1,2) order by name
     */
    ...
    public function saveAction() {
        ...
        if ($this->request->isPost()) {
            ...
            if ($model->save($this->request->getpost())) {
                $this->response->setJsonContent(array('status' => "SUCCESS", 'messages' => 'OK'));
            } else {
                $this->response->setJsonContent(array('status' => "ERROR", 'messages' => 'ERROR'));
            }
        }
        return $this->response;
    }
